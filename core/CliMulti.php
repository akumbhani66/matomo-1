...
class CliMulti
{
    ...
    private function executeNotAsyncHttp($url, Output $output)
    {
        ...
        try {
            ...
            $response = Http::sendHttpRequestBy('curl', $url, $timeout = 0, $userAgent = null, $destinationPath = null, $file = null, $followDepth = 0, $acceptLanguage = false, $this->acceptInvalidSSLCertificate, false, false, 'POST', null, null, $requestBody);
